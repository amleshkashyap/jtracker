  ...
  return (
    <div>
      <h2 id="job-heading" data-cy="JobHeading">
        <Translate contentKey="jhipsterJobApp.job.home.title">Jobs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterJobApp.job.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/job/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterJobApp.job.home.createLabel">Create new Job</Translate>
          </Link>
        </div>
      </h2>
        ...
        {jobList && jobList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterJobApp.job.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('company_id')}>
                  <Translate contentKey="jhipsterJobApp.job.company_id">Company Id</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('company_id')} />
                </th>
                ...
                <th className="hand" onClick={sort('url')}>
                  <Translate contentKey="jhipsterJobApp.job.url">Url</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('url')} />
                </th>
                <th className="hand" onClick={sort('role_id')}>
                  <Translate contentKey="jhipsterJobApp.job.role_id">Role Id</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('role_id')} />
                </th>
                <th className="hand" onClick={sort('min_experience')}>
                  <Translate contentKey="jhipsterJobApp.job.min_experience">Min Experience</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('min_experience')} />
                </th>
                <th className="hand" onClick={sort('languages')}>
                  <Translate contentKey="jhipsterJobApp.job.languages">Languages</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('languages')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterJobApp.job.home.notFound">No Jobs found</Translate>
            </div>
          )
        )}
      </div>
