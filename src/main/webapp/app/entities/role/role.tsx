  ...
  return (
    <div>
      <h2 id="role-heading" data-cy="RoleHeading">
        <Translate contentKey="jhipsterJobApp.role.home.title">Roles</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterJobApp.role.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/role/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterJobApp.role.home.createLabel">Create new Role</Translate>
          </Link>
        </div>
      </h2>
        ...
        {roleList && roleList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterJobApp.role.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="jhipsterJobApp.role.name">Name</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterJobApp.role.home.notFound">No Roles found</Translate>
            </div>
          )
        )}
      </div>
