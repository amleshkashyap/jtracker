  ...
  return (
    <div>
      <h2 id="application-heading" data-cy="ApplicationHeading">
        <Translate contentKey="jhipsterJobApp.application.home.title">Applications</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterJobApp.application.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/application/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterJobApp.application.home.createLabel">Create new Application</Translate>
          </Link>
        </div>
      </h2>
        ...
        {applicationList && applicationList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterJobApp.application.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('referral_id')}>
                  <Translate contentKey="jhipsterJobApp.application.referral_id">Referral Id</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('referral_id')} />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {applicationList.map((application, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/application/${application.id}`} color="link" size="sm">
                      {application.id}
                    </Button>
                  </td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/application/${application.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterJobApp.application.home.notFound">No Applications found</Translate>
            </div>
          )
        )}
      </div>
