...
import { deleteEntity, getEntity } from './application.reducer';
...
export const ApplicationDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/application${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterJobApp.application.delete.question">
        <Translate contentKey="jhipsterJobApp.application.delete.question" interpolate={{ id: applicationEntity.id }}>
